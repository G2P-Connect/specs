...
![](images/mapper\_benefits\_benficiary.png)
...
1. Financial Address Mapper - [Tech Architecture](https://centre-for-dpi.github.io/docs/publications/mapper\_architecture\_v1\_0.pdf)
